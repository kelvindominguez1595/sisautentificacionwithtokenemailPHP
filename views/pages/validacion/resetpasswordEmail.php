    ...
    <div class="container">
      ...
      <div class="row center">
        ...
        <form class="col s12 m6 offset-m3 card" method="POST" action="?view=Autentificacion&action=ValidateRequest">
          <h2 class="header center black-text">Recuperar contraseña</h2>
          <div class="row">
            ...
            <div class="input-field col s12">
              ...
              <input id="txtEmail" type="email" class="validate" name="txtEmail" placeholder="ejemplo@ejemplo.com"  required>
